...
type cliModeOptions struct {
	vertexImport     string
	sceMemoryImport  string
	sceMemoryScope   string
	sceMemoryScopeID string
	projectID        string
	password         string
	login            bool
	codexLogin       bool
...
func main() {
	...
	var sceMemoryImport string
	var sceMemoryScope string
	var sceMemoryScopeID string
	...
	flag.StringVar(&sceMemoryImport, "sce-memory-import", "", "Import SCE memory from the given root directory")
	flag.StringVar(&sceMemoryScope, "sce-memory-scope", "global", "Imported memory scope: global or api_key")
	flag.StringVar(&sceMemoryScopeID, "sce-memory-scope-value", "", "Imported memory scope value when scope is api_key")
	...
	runSelectedMode(cfg, configFilePath, options, cliModeOptions{
		...
		sceMemoryImport:  sceMemoryImport,
		sceMemoryScope:   sceMemoryScope,
		sceMemoryScopeID: sceMemoryScopeID,
		projectID:        projectID,
		password:         password,
		login:            login,
...
func runSelectedMode(cfg *config.Config, configFilePath string, options *cmd.LoginOptions, mode cliModeOptions) {
	...
	case mode.sceMemoryImport != "":
		cmd.DoSCEMemoryImport(cfg, configFilePath, mode.sceMemoryImport, mode.sceMemoryScope, mode.sceMemoryScopeID)
	case mode.login:
